...
public final class TkBudgetExpenditureDetailsPreview extends TkWrap {

    public TkBudgetExpenditureDetailsPreview(final DataSource src) {
        super(
            req -> {
                final XeSource srce = new XeChain(
                    new XeAppend(
                        "report_url",
                        String.format(
                            "/maccount/report/budget-expenditure-details/print?year=%s&treasury=%s",
