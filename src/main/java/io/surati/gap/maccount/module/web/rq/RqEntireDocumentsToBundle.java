...
import io.surati.gap.maccount.module.domain.db.DbPaginatedEntireDocumentsToBundle;
...
public final class RqEntireDocumentsToBundle implements DocumentsToBundle {

	private final DocumentsToBundle origin;

	public RqEntireDocumentsToBundle(final DataSource source, final Request req) throws IOException {
		...
		this.origin = new DbPaginatedEntireDocumentsToBundle(
		    source,
			nbperpage,
			page,
			title,
