...
public final class TkBundleEntireWarrants implements Take {
	 ...
	 */
	public TkBundleEntireWarrants(final DataSource source) {
		this.source = source;
	}
	...
	public Response act(Request req) throws Exception {
		try {
			...
			new DbPaginatedEntireWarrantsToBundle(
				this.source,
				nbperpage,
				page,
				title,
				...
				year,
				filter
			).bundle(new RqUser(this.source, req));
			return new RsJson(
